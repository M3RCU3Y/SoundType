...
- Freesound CC0 typewriter recordings by exterminat, nvmbky, Spacekittycat, and Gate13. SoundType imports preview/download audio as segmented one-shot clips with per-pack `SOURCE.txt` files.
